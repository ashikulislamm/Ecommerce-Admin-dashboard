...
import { X, Loader2, Package, Upload } from 'lucide-react';
      ...
      <div className="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-xl border border-slate-200 space-y-4 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Standalone product with single pricing & inventory</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-3">
            <h3 className="font-bold text-slate-800 uppercase tracking-wider text-[11px]">Pricing & Inventory</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <div className="max-h-28 overflow-y-auto p-2 border border-slate-200 rounded-xl bg-slate-50 space-y-1">
          ...
          <div className="p-3 rounded-xl border border-slate-200 space-y-2 bg-slate-50/50">
            <h3 className="font-bold text-slate-800 uppercase tracking-wider text-[11px]">Primary Media & Gallery</h3>
            <p className="text-[11px] text-slate-500">Select uploaded images from your Media Library:</p>

            <div className="grid grid-cols-4 sm:grid-cols-6 gap-2 max-h-36 overflow-y-auto p-2 border border-slate-200 rounded-xl bg-white">
              {mediaData?.map((m) => {
          ...
          <div className="flex justify-end gap-2 pt-3 border-t border-slate-100">
            ...
            >
              ...
              {editProduct ? 'Save Changes' : 'Create Simple Product'}
            </button>
          </div>
        </form>
      </div>
